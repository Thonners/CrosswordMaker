 ...
 * Create an instance of the button with the text you'd like to display, then add it to the
 * relevant RelativeLayout.
 * <p>
...
public class FooterButton extends CardView {
    ...
    private void initialise() {
        ...
        buttonRL.setPadding(getResources().getDimensionPixelOffset(R.dimen.edit_button_padding),
                getResources().getDimensionPixelOffset(R.dimen.edit_button_padding),
                getResources().getDimensionPixelOffset(R.dimen.edit_button_padding),
                getResources().getDimensionPixelOffset(R.dimen.edit_button_padding));
        // Text view
        ...
        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                getResources().getDimension(R.dimen.home_card_text_size_main));
